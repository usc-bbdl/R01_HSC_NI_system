function set_mu(fname)
open_system('size_principle');
%open_system('test/twitch');
set_param('size_principle','Lock','off')
...
save_system('size_principle');

for i = 1:20
    eval(['SIZE_MU_', num2str(i), '=', num2str('(atan(100) - atan(i)) * 7')])
end